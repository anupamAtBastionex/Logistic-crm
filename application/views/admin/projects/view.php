...
<script>
    // Assuming you have a function to trigger the AJAX request
    function initRelationTasks() 
    {
        alert(admin_url);
        var sprint_id = 1; // Replace with the actual value
        var project_id = 1;
        $.ajax({
                    url: admin_url + 'task/init_relation_tasks/' + project_id + '/project/' + sprint_id,
                    type: 'POST',
                    data: {},
                    cache: false,
                    contentType: false,
