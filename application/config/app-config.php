...
*
*/
define('APP_BASE_URL', 'http://localhost/crm/crm/');
...
*/
define('APP_ENC_KEY', '15ac72a395d7521cb3787fad6b1fba9f');
 ...
 */
define('APP_DB_PASSWORD', 'root@123');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'prefix_crm');
